...
const ds = StyleSheet.create({
  ...
  backBtn:       { padding: 4 },
  headerCenter:  { flex: 1 },
  headerTitle:   { fontFamily: 'Dronien', fontSize: 16, fontWeight: '700', letterSpacing: 0.3 },
  headerSub:     { fontFamily: 'Dronien', fontSize: 11, marginTop: 1 },
  ...
  licenseBtnText: { fontFamily: 'Dronien', fontSize: 11, fontWeight: '600' },
  scroll:        { paddingBottom: 60 },
  modeBanner:    { flexDirection: 'row', alignItems: 'center', gap: 8, margin: 16, padding: 12, borderRadius: 10, borderWidth: 1 },
  modeText:      { fontFamily: 'Dronien', flex: 1, fontSize: 12, lineHeight: 17 },
  section:       { paddingHorizontal: 16, marginBottom: 8 },
  sectionTitle:  { fontFamily: 'Dronien', fontSize: 14, fontWeight: '600', marginBottom: 12, marginTop: 8 },
  ...
  gpsBtnText:    { fontFamily: 'Dronien', fontSize: 14 },
  ...
  resetText:     { fontFamily: 'Dronien', fontSize: 12 },
  orText:        { fontFamily: 'Dronien', fontSize: 12, textAlign: 'center', marginBottom: 12 },
  pickerSection: { marginBottom: 12 },
  pickerLabel:   { fontFamily: 'Dronien', fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 },
  ...
  pillText:      { fontFamily: 'Dronien', fontSize: 13 },
  pillTextActive:{ fontFamily: 'Dronien', color: '#0ea5e9', fontWeight: '600' },
  loadingWrap:   { alignItems: 'center', padding: 40, gap: 12 },
  loadingText:   { fontFamily: 'Dronien', fontSize: 13 },
  badge:         { margin: 16, borderRadius: 16, borderWidth: 1, overflow: 'hidden' },
  badgeGrad:     { padding: 18, alignItems: 'center', gap: 8 },
  badgeLabel:    { fontFamily: 'Dronien', fontSize: 18, fontWeight: '700', letterSpacing: 1 },
  issueRow:      { flexDirection: 'row', alignItems: 'flex-start', gap: 6, marginTop: 4 },
  issueText:     { fontFamily: 'Dronien', fontSize: 12, flex: 1, lineHeight: 17 },
  ...
  infoLabel:     { fontFamily: 'Dronien', fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.3 },
  infoValue:     { fontFamily: 'Dronien', fontSize: 22, fontWeight: '700' },
  infoUnit:      { fontFamily: 'Dronien', fontSize: 13, fontWeight: '400' },
  infoSub:       { fontFamily: 'Dronien', fontSize: 11, marginTop: 2 },
  ruleNote:      { fontFamily: 'Dronien', color: '#f97316', fontSize: 12, marginTop: 8, lineHeight: 17 },
  tipRow:        { flexDirection: 'row', gap: 8, marginBottom: 8, alignItems: 'flex-start', padding: 10, borderRadius: 8, borderLeftWidth: 3 },
  tipText:       { fontFamily: 'Dronien', fontSize: 13, flex: 1, lineHeight: 19 },
  ...
  regKey:        { fontFamily: 'Dronien', fontSize: 13 },
  regVal:        { fontFamily: 'Dronien', fontSize: 13, fontWeight: '500', flex: 1, textAlign: 'right' },
  dataSource:    { fontFamily: 'Dronien', fontSize: 10, textAlign: 'center', marginTop: 16, marginBottom: 8, paddingHorizontal: 16 },
  emptyState:    { alignItems: 'center', paddingTop: 80, gap: 16 },
  emptyText:     { fontFamily: 'Dronien', fontSize: 14, textAlign: 'center', lineHeight: 22 },
});
